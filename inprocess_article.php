				...
				<div class="table-responsive-xl">
					<table align='center' id='myTable' class='display table' style='width:100%'>
						...
						<?php
							...
							$Article_Id_Status;
							$Approved_Date;
							$sql = "SELECT * FROM `tnk_articles` WHERE `user_id`='$user_id' AND `approved_or_not`='0'";
							...
							while ($row = mysqli_fetch_array($result)) {
								...
								echo "
									...
									<tr>
										...
										<td>".$Approved_Date."</td>
										<td><a class='btn btn-primary btn-sm' href='article_approve.php?id=".$row['id']."'>Approve</a></td>
										<td><a class='btn btn-danger btn-sm' href='article_delete.php?id=".$row['id']."'>DEL</a></td>
									</tr>
									<tr>
										<td colspan='10'>
